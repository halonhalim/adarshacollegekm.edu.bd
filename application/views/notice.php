							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="inner-page">
										<div class="content">
											<?php
												foreach ($this->notice_model->details($this->uri->segment(3)) as $row) {
													echo "<h3 class='head_black'>".$row->title."</h3>";
													echo "<p class='paragraph'>".nl2br($row->details)."</p>";
													if ($row->file_name) {
														echo "<a href='".base_url().'assets/filemanager/notice/'.$row->file_name."' target='_blank'><img src='".base_url().'assets/filemanager/pdf.png'."' width='50' /></a>";
													}
												} 
											?>
										</div>
