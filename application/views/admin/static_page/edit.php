		...
		<div class="widget-box widget-color-blue" id="widget-box-2">
			...
			<div class="widget-body">
				<div class="widget-main">
					<form id="myForm" action="<?php echo base_url() . 'static_page/update/'; ?>" class="form-horizontal" method="post" enctype="multipart/form-data">   
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<?php if($edit->file_name) { ?>
									<br /><br />
									<img src="<?php echo base_url() . 'assets/filemanager/static_page/'. $edit->file_name; ?>" width="100px" class="img-responsive" />
								<?php } ?>
							</div>
						</div>
