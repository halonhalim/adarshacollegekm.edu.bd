...
class Student_scholarship_model extends CI_Model {

	var $table = 'student_scholarship';
	var $column_order = array(null, 'name', 'study_duration', 'achievement');
	var $column_search = array('name', 'study_duration', 'achievement');
